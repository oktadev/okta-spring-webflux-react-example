...
<details><summary>src/main/java/com/example/demo/Profile.java</summary>
[source,java]
----
...
<details><summary>src/main/java/com/example/demo/ProfileRepository.java</summary>
[source,java]
----
package com.example.demo;
...
<details><summary>src/main/java/com/example/demo/SampleDataInitializer.java</summary>
[source,java]
----
package com.example.demo;
